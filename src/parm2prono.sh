...
AHORA=`python print_timestamp.py`
...
echo -----------------------------------------------------------------------
echo "ejecutare gen_prono.py $TENANT $VARNAME $FROMEPOCH $TOEPOCH $FRECUENCY"
echo -----------------------------------------------------------------------
python gen_prono.py $TENANT $VARNAME $FROM $TO $FRECUENCY
