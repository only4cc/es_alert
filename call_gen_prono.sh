...
do
  ...
  docker run --rm --network="host" --name gen_prono -v /home/es_alert/cfg/config.yml:/src/config.yml:ro es_alert:latest python gen_prono.py  $var $FROMEPOCH $TOEPOCH $LAPSO
